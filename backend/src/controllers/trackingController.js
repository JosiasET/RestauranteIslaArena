  ...
  try {
    ...
    const formattedOrder = {
      ...
      order_type: order.order_type // ✅ AGREGAR
    };
  ...
  try {
    ...
    // Formatear respuesta - ✅ AGREGAR order_type
    const formattedOrders = result.rows.map(order => ({
      ...
      customer_phone: order.phone,
      customer_email: order.email,
      order_type: order.order_type // ✅ ESTA LÍNEA FALTA
    }));
    ...
    // En trackingController.js - MÉTODO createOrder CORREGIDO
createOrder: async (req, res) => {
  ...
  try {
    ...
    console.log('🔄 Creando pedido simple...');
    ...
    console.log('✅ Pedido simple creado:', orderResult.rows[0].tracking_code);
